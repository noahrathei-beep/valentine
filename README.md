[index.html](https://github.com/user-attachments/files/25178624/index.html)
<!DOCTYPE html>
<html lang="de">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Willst du mein Valentinstags‑Date sein? 💘</title>
  <meta name="description" content="Eine charmante kleine Seite mit jaa/nein – mit einem frechen Twist." />
  <style>
    :root{
      --bg1:#ff97b7;
      --bg2:#ffc3d6;
...
<body>
  ...
  <div class="wrap">
    <main class="card" role="dialog" aria-labelledby="title" aria-describedby="subtitle">
      ...
      <div class="pill" aria-hidden="true">💌 Kleine Frage von Noah</div>
      <h1 class="title" id="title">Willst du mein Valentinstags‑Date sein?</h1>
      <p class="subtitle" id="subtitle">Ich bringe auch Blumen mit. Versprochen. 🌷✨</p>
  ...
  <script>
    ...
    yesBtn.addEventListener('click', () => {
      msg.textContent = "Perfekt – ich freue mich! 🥰";
    ...
    noBtn.addEventListener('click', () => {
      ...
      if (noClicks >= maxClicksBeforeHide) {
        ...
        msg.textContent = "Ups… der „Nein“-Button ist irgendwie verschwunden. Vielleicht ein Zeichen? 😉";
        msg.classList.add('show');
      }
    });
  </script>
...
if __name__ == "__main__":
    # Für lokale Entwicklung in VS Code
